...
INSERT INTO PATIENT (first_name, last_name, telephone_number, email, patient_number, date_of_birth, marital_status, address_id, version)
VALUES
    ('Jan', 'Kowalski', '123-456-789', 'jan.kowalski@example.com', 'PAT12345', '1985-07-12', 'MARRIED', 1, 1),
    ('Anna', 'Nowak', '987-654-321', 'anna.nowak@example.com', 'PAT67890', '1992-03-25', 'MARRIED', 2, 1),
    ('Jan', 'Wiśniewski', '555-666-777', NULL, 'PAT11223', '1978-11-08', 'SINGLE', 3, 1),
    ('Ewa', 'Dąbrowska', '333-222-111', 'ewa.dabrowska@example.com', 'PAT44556', '2000-06-30', 'DIVORCED', 4, 1),
    ('Marek', 'Nowak', '777-888-999', 'marek.zielinski@example.com', 'PAT77889', '1995-09-15', 'WIDOWED', 5, 1);
